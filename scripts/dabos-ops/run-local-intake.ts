#!/usr/bin/env npx tsx
import { getIntakePreflight, getPipelinePaths } from '@/lib/dabos-ops/document-intake/config';
import { processInbox } from '@/lib/dabos-ops/document-intake/pipeline';
import { ensurePipelineDirectories } from '@/lib/dabos-ops/document-intake/storage';
