...
import { fetchPathCompletions, type PathCompleteResult } from '@/lib/dabos-ops/document-intake/review-api-client';
...
export function PathAutocompleteInput({
  ...
  /** Only show dropdown after the user types or presses ArrowDown â€” not on passive value load. */
