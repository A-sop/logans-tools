...
import type { LearningThresholds, PipelinePaths } from '@/lib/atlas-ops/document-intake/types';
 ...
 * Default 2 (first 1–2 pages) per the Tranche A ruling. 0 = whole document.
 */
