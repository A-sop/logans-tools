...
import {
  ...
  scoreTextQuality,
} from '@/lib/atlas-ops/document-intake/filename-heuristics';
import { runFastPathOcr } from '@/lib/atlas-ops/document-intake/extractors/ocr-fastpath';
import type { ExtractionResult, TextQuality } from '@/lib/atlas-ops/document-intake/types';
...
function shouldRunOcrFallbackOnText(extractedText: string): boolean {
  return (
    ...
    // checks yet must still be OCR'd — this is the COR1389 failure mode.
