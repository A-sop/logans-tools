...
} from '@/lib/atlas-ops/document-intake/review-config';



/** Browser client — talks only to /api/dil/review/* so the backend can be replaced later. */
...
/** Instant slice from registry — never runs OCR. */
