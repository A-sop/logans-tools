  ...
  return {
    ...
    dailyNudge:
      readyForHuman > 0
        ...
        : 'Pipeline can refill queues — run daily triage when you have 10 minutes.',
    dataInbox: {
      ...
      action: 'Open DIL review — rename, bucket, approve filing.',
    },
    wikiCapture: {
      label: 'Telegram → wiki',
      rawCount: wiki.raw,
      ...
      action: 'Confirm triage.md → wiki or DATA.',
    },
    dilReview: {
      todo: dilTodo,
      later: dilLater,
